...
namespace MPack
{
    public class MPackMap : MPack, IDictionary<MPack, MPack>
    {
        ...
        public ICollection<MPack> Keys
        { get { return _collection.Keys; } }

        public ICollection<MPack> Values
        { get { return _collection.Values; } }

        public override object Value
        { get { return _collection; } }

        public override MPackType ValueType
        { get { return MPackType.Map; } }

        private readonly IDictionary<MPack, MPack> _collection;
